...
return [
    ...
    'attributes' => [
        'sortableAndSearchable'      => 'Data :value tidak dapat dicari.',
        'sortableAndSearchableExist' => 'Data :value tidak ditemukan.',
        'dataNotExist'               => 'Data :attr tidak ditemukan.',
        'dataNotExistWithID'         => 'Data :attr dengan id :id tidak ditemukan.',
    ],
